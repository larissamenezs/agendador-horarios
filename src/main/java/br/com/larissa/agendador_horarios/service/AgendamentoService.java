package br.com.larissa.agendador_horarios.service;

import br.com.larissa.agendador_horarios.infrastructure.entity.Agendamento;
import br.com.larissa.agendador_horarios.infrastructure.repository.AgendamentoRepository;
...
public class AgendamentoService {
    ...
    public Agendamento salvarAgendamento(Agendamento agendamento) {
        ...
        LocalDateTime horaFim = agendamento.getDataHoraAgendamento().plusHours(1); //verifica se dentro dessas "1h" não tem ninguém agendado

        Agendamento agendados = agendamentoRepository.findByServicoAndDataHoraAgendamentoBetween(agendamento.getServico(), horaAgendamento,
                horaFim);
