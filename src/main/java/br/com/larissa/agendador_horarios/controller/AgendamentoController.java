package br.com.larissa.agendador_horarios.controller;

import br.com.larissa.agendador_horarios.infrastructure.entity.Agendamento;
import br.com.larissa.agendador_horarios.service.AgendamentoService;
...
public class AgendamentoController {
    ...
    @PutMapping
    public ResponseEntity<Agendamento> alterarAgendamentos(@RequestBody Agendamento agendamento, @RequestParam String cliente,
                                                           @RequestParam LocalDateTime dataHoraAgendamento) {
